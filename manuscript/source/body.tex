...
The caveat here is that applications with lower risk levels are not required to provide the same level of evidence as an application class at a higher risk, and therefore the highest burdens of proof is required exclusively for high risk applications. 
