...
\subsection{Application \& Criticality Filtering and Prioritisation}
...
A criticality assessment is applied at this stage, using a process akin to a hazard analysis for each of the filtered qualities to assess safety, potential harm or impact of failing to uphold the quality in operation.
...
%
An important factor that the stakeholders will consider is the scope of the automation; how automated the system is or will be in the future, the application criticality including the potential harm from the system not upholding the trustworthy attribute/quality.
